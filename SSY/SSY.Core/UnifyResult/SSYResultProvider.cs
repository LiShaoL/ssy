...
/// 规范化RESTful风格返回值
/// </summary>
[SuppressSniffer, UnifyModel(typeof(SSYResult<>))]
public class SSYResultProvider : IUnifyResultProvider
{
    ...
    public IActionResult OnValidateFailed(ActionExecutingContext context, ValidationMetadata metadata)
    {
        return new JsonResult(RESTfulResult(metadata.StatusCode ?? StatusCodes.Status400BadRequest, data: metadata.Data,
            errors: metadata.FirstErrorMessage ?? metadata.Message), UnifyContext.GetSerializerSettings(context));
    }
    ...
    /// <returns></returns>
    private static SSYResult<object> RESTfulResult(int statusCode, bool succeeded = default,
        object data = default, object errors = default)
    {
        return new SSYResult<object>
        {
            Code = statusCode,
